...
public class LL extends Block implements Tiles {
    ...
    public LL(int positionX, int positionY) {
        ...
        tile[3] = new Block(tile[0].getPositionX(), tile[0].getPositionY() + getSizes(), COLOR, getSizes());
    ...
    public void rotate() {
        ...
        if (isHorizontal() == 1) {
            if ((tile[0].getPositionY() + getSizes()) / 10 + 1 >= 23 || (tile[0].getPositionY() + getSizes() * 2) / 10 <= 0) {
            ...
            if ((tile[0].getPositionX() - 2 * getSizes()) / 10 <= -1 || (tile[0].getPositionX() + getSizes() * 2) / 10 >= 10) {
                System.out.println("unsuccesful");
                succesful = false;
                temp = tile;
            }
        ...
        if (succesful) {
            ...
            if (isHorizontal() == 1) {
                ...
                temp[2] = new Block(x, y + getSizes() * 2, COLOR, getSizes());
            ...
            //Moving  vertically
                ...
                temp[2] = new Block(x - getSizes() * 2, y, COLOR, getSizes());
        ...
        if (tile[3].getPositionY() != 230) {
            ...
            if (succesfu) {
                ...
                if (!succesfu) {
                    ...
                    for (Block b : temp) {
                        GamePlayController.setPlayingBoard(b.getPositionY() / 10, b.getPositionX() / 10, 6);
                    }
                }
                set(temp);
...
//                System.out.println(I[0].getPositionY());
    ...
    private int isHorizontal() {
        if (tile[0].getPositionY() - tile[3].getPositionY() < 0) {
            return 1;
        } else if (tile[0].getPositionY() - tile[3].getPositionY() > 0) {
            return 3;
        } else if (tile[0].getPositionY() - tile[3].getPositionY() == 0 && tile[0].getPositionY() < tile[1].getPositionY()) {
            return 2;
        } else {
            return 4;
        }
