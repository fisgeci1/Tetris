...
public class ZR extends Block implements Tiles {

    private Block[] tile = new Block[4];
    private static final Color COLOR = Color.RED;

    public ZR(int positionX, int positionY) {

        for (int i = 0; i < 2; i++) {
            tile[i] = new Block(positionX + getSizes() * i, positionY, COLOR, getSizes());
        }
        tile[2] = new Block(tile[1].getPositionX(), positionY - getSizes(), COLOR, getSizes());
        tile[3] = new Block(tile[1].getPositionX() + getSizes(), positionY - getSizes(), COLOR, getSizes());
    ...
    public void rotate() {
        ...
        if (succesful) {
            ...
            if (isHorizontal()) {
                ...
                temp[2] = new Block(tile[0].getPositionX(), y, COLOR, getSizes());
                temp[3] = new Block(tile[0].getPositionX(), y - getSizes() * (1), COLOR, getSizes());
