...
public class T extends Block implements Tiles {
    ...
    public T(int positionX, int positionY) {
        ...
        tile[3] = new Block(tile[1].getPositionX(), positionY + getSizes(), COLOR, getSizes());
    }
    ...
    public void rotate() {
        ...
        if (isHorizontal() == 1) {
            if ((tile[1].getPositionY() + getSizes()) / 10 + 1 >= 23 || (tile[1].getPositionY() - getSizes()) / 10 <= 0) {
                System.out.println("unsuccesful");
                succesful = false;
                temp = tile;
            }
        } else if (isHorizontal() == 2) {
            if ((tile[1].getPositionX() - getSizes()) / 10 <= -1 || (tile[1].getPositionX() + getSizes()) / 10 >= 10) {
                System.out.println("unsuccesful");
                succesful = false;
                temp = tile;
            }
        ...
        if (tile[3].getPositionY() != 230 && succesful) {
            for (Block b : tile) {
        ...
        if (succesful) {
            ...
            int y = tile[1].getPositionY();
            int x = tile[1].getPositionX();
            if (isHorizontal() == 1) {
                for (Block b : tile) {
                    GamePlayController.setPlayingBoard(b.getPositionY() / 10, b.getPositionX() / 10, 0);
                }
                temp[0] = new Block(x, y - getSizes(), COLOR, getSizes());
                temp[1] = new Block(x, y, COLOR, getSizes());
            ...
            //Moving  vertically
                ...
                temp[0] = new Block(x - getSizes(), y, COLOR, getSizes());
                temp[1] = new Block(x, y, COLOR, getSizes());
    ...
    public void moveX() {
        ...
        if (tile[3].getPositionY() != 230) {
            if (dir >= 0) {
                if (isHorizontal() == 1) {
                    if (tile[2].getPositionX() / 10 + 1 == 10) {
                        succesfu = false;
                        temp = tile;
                    }
            ...
            if (succesfu) {
                ...
                if (!succesfu) {
                    ...
                    for (Block b : temp) {
                        GamePlayController.setPlayingBoard(b.getPositionY() / 10, b.getPositionX() / 10, 7);
                    }
                }
                set(temp);
    ...
    public void moveDown() {
        ...
        if ((temp[0].getPositionY() / 10 != -1 &&
                temp[2].getPositionY() / 10 != -1 &&
                temp[1].getPositionY() / 10 != -1
                && (temp[3].getPositionY() / 10 != -1)) &&
...
//                System.out.println(I[0].getPositionY());
    ...
    private int isHorizontal() {
        if (tile[1].getPositionY() - tile[3].getPositionY() < 0) {
            return 1;
        } else if (tile[1].getPositionY() - tile[3].getPositionY() > 0) {
            return 3;
        } else if (tile[1].getPositionY() - tile[3].getPositionY() == 0 && tile[1].getPositionY() > tile[0].getPositionY()) {
            return 2;
        } else {
            return 4;
        }
